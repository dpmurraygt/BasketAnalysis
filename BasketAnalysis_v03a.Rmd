...
colnames(TransStore)<-c("TransID", "Date", "Time", "Store", "StoreDiv", "State", "Latitude", "Longitude", 
                        "SqFt", "Sales", "Units")
...
RBWide<-spread(RBTrans, Desc, Present, fill = FALSE)

TransDF<-as.data.frame(SummaryWide)

#write.csv(BasketSummary, "RBBasketSummary.csv")

#This moves the data from being a long data table to being a wide sparse matrix as required for the 
#arules library to work
#SummaryWide<-read.transactions("RBBasketSummary.csv", format="single", sep=",", cols=c("TransactionID", "Desc"))


#match the transaction to store


#Cluster? based on Transaction contents?
